...
public interface EventBusOptions {
     ...
     */
    EventBusOptions setRestrictedToClass(Class<?> event);
    /**
    ...
    EventBusOptions setListenerException(Exception e);

    Exception getListenerException();
